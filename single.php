        ...
        <main>
            ...
            <div class="container">
                ...
                <section class="mt-5 wow fadeIn">
                    ...
                    <div class="row">
                        <div class="col-md-3"><!-- IMG PORTADA -->
                        ...
                        <div class="keywords">
                            <p class="text_keywords"><?php echo get_the_term_list( $post->ID, 'Keywords' ); ?></p>
                        </div>
                        <hr>
                        ...
                        <div class="col-md-7" style="margin-top: 1.8em;"><!-- INFO. LIBRO -->
                        
                        <p class="text_tit_obra"><a target="_blank" href="<?php echo get_post_meta($post->ID, 'download_pdf', true); ?>"><?php the_title(); ?></a></p>
                        ...
                        <div class="text_desc"><?php the_excerpt(); ?></div>
                        <hr>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <td class="text_datos_lib"><span class="naranja boldsp">CITAR DIRECTO</span> <img src="<?php bloginfo('template_url'); ?>/img/doi.png" alt="" style="width: 30px;"> <span class="boldsp azul_link"><a href="https://doi.org/<?php echo get_post_meta($post->ID, 'doi', true); ?>" target="_blank">https://doi.org/<?php echo get_post_meta($post->ID, 'doi', true); ?></a></span></td>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                        ...
                        <div class="separar"></div>
                        <table><!-- DATOS "ÚNICOS" del LIBRO -->
                        <tr>
                            <td class="text_datos_lib">Año: <?php echo get_post_meta($post->ID, 'fecha_publicacion_impreso', true); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="text_datos_lib">Edición: <?php echo get_post_meta($post->ID, 'edicion', true); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="text_datos_lib">
                                ...
                                <?php if((get_post_meta( get_the_ID(), 'coleccion_term', true ) )){ ?>
                                    Colección: <?php echo get_post_meta($post->ID, 'coleccion_term', true); ?>
                                <?php }else{ ?>
                                    Colección: Conocimiento
                                <?php } ?>

                                <!--<?php echo get_the_term_list( $post->ID, 'Genero', '', ', ', '' ); ?>--></td>
                            <td></td>
                        </tr>
                        <?php if (get_post_meta( get_the_ID(), 'coeditor', true ) ) { ?>
                        <tr>
                            <td class="text_datos_lib">Coeditor: <?php echo get_post_meta($post->ID, 'coeditor', true); ?></td>
                            <td></td>
                        </tr>
                        <?php } ?>
                        <tr>
                            <td class="text_datos_lib">ISBN: <?php echo get_post_meta($post->ID, 'isbn', true); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="text_datos_lib">Páginas: <?php echo get_post_meta($post->ID, 'paginas_impreso', true); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="text_datos_lib">Tamaño: <?php echo get_post_meta($post->ID, 'medidas_impreso', true); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <!--<td class="text_datos_lib">
                        ...
                        <div class="col-md-2" style="padding: 0;">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-4 contVisDes">
                                    ...
                                    <p class="text-center contVisDesNum"><strong><?php echo do_shortcode( '[shortcont]' ); ?></strong></p>
                                </div>
                                
                                <div class="col-md-12 mt-3 contVisDes">
                                    <p class="contVisDesTxt text-center">Descargas</p>
                                    <p class="text-center contVisDesNum"><strong><?php echo do_shortcode( '[shortcontDesc]' ); ?></strong></p>
                                </div>
                            </div>
                            <hr>
                            <!-- DICTAMINACIÓN PDFs -->
                ...
                <section class="mt-5 wow fadeIn">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3"><!-- GRÁFICA y PDFs -->
                            ...
                            <div class="col-md-9"><!-- TAB "PESTAÑAS" - INFO. LIBRO -->
                            <div class="row d-flex justify-content-center"><!-- TAB "PESTAÑAS" - QUIQUE -->
                            <div class="col-md-12">
                                <ul class="nav nav-tabs " id="myTab" role="tablist" style="width: 100%">
                                    <li class="nav-item" style="width: 15%; text-align: center;"><!-- "Secc. - RESUMEN" -->
                                    <a class="nav-link text_tits_prfLib active" id="resumen" data-toggle="tab" href="#cont_resumen" role="tab" aria-controls="home"
                                    aria-selected="true">Resumen</a>
                                    </li><!--/. "Secc. - RESUMEN" -->
                                    
                                    <li class="nav-item" style="width: 15%; text-align: center;"><!-- "Secc. - AUTORES" -->
                                    ...
                                    <li class="nav-item" style="width: 35%; text-align: center;"><!-- "Secc. - IMPACTO DE LA INVESTIGACIÓN" -->
                                    ...
                                    </li><!--/. "Secc. - IMPACTO DE LA INVESTIGACIÓN" -->
                                    <li class="nav-item" style="width: 20%; text-align: center;"><!-- "Secc. - IMPACTO DE LA INVESTIGACIÓN" -->
                                    ...
                                    </li><!--/. "Secc. - IMPACTO DE LA REDES" -->
                                    <li class="nav-item" style="width: 15%; text-align: center;"><!-- "Secc. - IMPACTO DE LA INVESTIGACIÓN" -->
                                ...
                                <div class="tab-content paddTab" id="myTabContent"><!-- CONTENIDO CARRUSEL  -->
                                <div class="tab-pane fade show active" id="cont_resumen" role="tabpanel" aria-labelledby="home-tab"><!-- Contenido RESUMEN -->
                                <div class="pgen">
                                    <?php the_content(); ?>
                                </div>
                                
                                </div><!--/. Contenido RESUMEN -->
                                
                                
                                <div class="tab-pane fade" id="cont_autores" role="tabpanel" aria-labelledby="profile-tab"><!-- Contenido AUTORES -->
                                <?php foreach (get_the_terms(get_the_ID(), 'Autores') as $cat) : ?>
                                <p class="pgen"><?php echo $cat->name; ?></p>
                                <?php echo $cat->description; ?>
                                <p><br/></p>
                                <p><img style="height: 30px; float: left; margin-right: 10px" src="<?php bloginfo('template_url'); ?>/img/orcid-og-image.png" alt="ORCID logo"><a href="<?php echo get_term_meta( $cat->term_id, 'autores_orcid', true ); ?>"><?php echo get_term_meta( $cat->term_id, 'autores_orcid', true ); ?></a></p>
                                <hr>
                                <?php endforeach; ?>
                                </div><!--/. Contenido AUTORES -->
                                
                                <div class="tab-pane fade" id="cont_imp_invs" role="tabpanel" aria-labelledby="contact-tab"><!--/. Contenido MÉTRICA -->
                                ...
                                </div><!--/. Contenido MÉTRICA -->
                                <div class="tab-pane fade" id="cont_redes" role="tabpanel" aria-labelledby="redes-tab"><!-- Contenido REDES -->
                                <p>REDES SOCIALES</p>
                                </div><!--/. Contenido REDES -->
                                <div class="tab-pane fade" id="cont_videos" role="tabpanel" aria-labelledby="videos-tab"><!-- Contenido REDES -->
                                <p>VIDEOS</p>
                                </div><!--/. Contenido REDES -->
                                
                                </div><!--/. Contenido MEDIOS -->
                                </div><!--/. TAB "PESTAÑAS" - INFO. LIBRO -->
                ...
                <!--Main layout-->
                <!-- Modal CITA -->
                <div class="modal fade" id="modalcitar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="contact-form">
                                    <p id="myInput" class="copy-text"><?php echo get_post_meta($post->ID, 'citar-directo', true); ?></p>
                ...
                <div class="modal fade" id="modal-ficha-catalografica" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                                ...
                                <div class="contact-form">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><p class="autores-ficha-catalografica"><?php echo get_the_term_list( $post->ID, 'Autores', '', ', ', '' ); ?></p></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo get_post_meta($post->ID, 'fecha_publicacion_impreso', true); ?></td>
                                        </tr>
                                        <tr>
